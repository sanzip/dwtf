...
if(isset($_POST['btn_create']) && ($_SERVER['REQUEST_METHOD']== "POST"))
  ...
  $qry = "INSERT INTO user(user_id, username, password, email, fellowship_place, batch, number, photo) VALUES('" . $userid . "', '" . $username . "', '" . $password . "','" . $email . "','" . $fellowship_place . "','" . $batch . "','" . $number . "','" . $photo . "')";
