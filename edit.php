...
{    
  ...
  $qry="UPDATE  users SET username='$username',email='$email',batch='$batch',fellowship_place='$fellowship_place',number='$number',image='$photo',school_name='$school_name' where user_id='$userid'";
